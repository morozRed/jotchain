...
// Light mode only - no dark theme needed
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-border-subtle bg-surface px-2.5 py-1.5 text-xs shadow-md",
          className
        )}
      >
